...
def plot_results(
    ...
    plt.plot(
        best_x[0], best_x[1], c="blue", marker="o", linestyle="-", label="Best solution"
    )
    plt.legend()
    plt.show()
...
def plot_results_with_population(
    ...
    for i, individual_index in enumerate(range(len(individuals))):
        individuals[individual_index]["position_history"] = np.asarray(
            individuals[individual_index]["position_history"]
        )
        if i == 0:
            ...
            label = None
        plt.plot(
            individuals[individual_index]["position_history"][:, 0],
            individuals[individual_index]["position_history"][:, 1],
            c="red",
            marker="o",
            linestyle="-",
            label=label,
